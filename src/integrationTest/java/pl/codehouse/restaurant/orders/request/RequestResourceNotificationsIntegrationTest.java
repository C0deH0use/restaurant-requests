...
import static pl.codehouse.restaurant.orders.request.MenuItemEntityBuilder.aMenuItemEntity;
...
class RequestResourceNotificationsIntegrationTest {
    ...
    private static @NotNull RecordHeaders getRecordHeaders() {
        ...
        recordHeaders.add("__TypeId__", "pl.codehouse.restaurant.orders.request.RequestStatusChangeMessage".getBytes(StandardCharsets.UTF_8));
